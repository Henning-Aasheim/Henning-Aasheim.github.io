        ...
        <header className="w-screen border-b border-black/10 dark:border-white/70 py-6 px-1 sm:px-10">
            <nav className="flex items-center w-full">
                ...
                <div className="flex mr-5 xs:mr-0 space-x-4 2xs:space-x-12 font-default justify-center text-base xs:text-xl">
                    <Link href='/' className="text-textblue dark:text-gray-300 font-bold  hover:scale-110">{t('home')}</Link>
                    <Link href='/about' className="text-textblue dark:text-gray-300 font-bold hover:scale-110">{t('about')}</Link>
                    <Link href='/blog' className="text-textblue dark:text-gray-300 font-bold hover:scale-110">{t('blog')}</Link>
                </div>
